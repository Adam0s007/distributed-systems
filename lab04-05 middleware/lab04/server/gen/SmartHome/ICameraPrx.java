...
public interface ICameraPrx extends IDevicePrx
{
    default CameraMode getCameraMode()
        throws NotEnabledException
    {
        return getCameraMode(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default CameraMode getCameraMode(java.util.Map<String, String> context)
        throws NotEnabledException
    {
        try
        {
            return _iceI_getCameraModeAsync(context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<CameraMode> getCameraModeAsync()
    {
        return _iceI_getCameraModeAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<CameraMode> getCameraModeAsync(java.util.Map<String, String> context)
    {
        return _iceI_getCameraModeAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<CameraMode> _iceI_getCameraModeAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<CameraMode> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getCameraMode", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_getCameraMode);
        f.invoke(true, context, null, null, istr -> {
                     CameraMode ret;
                     ret = CameraMode.ice_read(istr);
                     return ret;
                 });
        return f;
    }
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getCameraMode =
    {
        NotEnabledException.class
    };

    default boolean setCameraMode(CameraMode mode)
        throws CameraOperationException,
               NotEnabledException
    {
        return setCameraMode(mode, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean setCameraMode(CameraMode mode, java.util.Map<String, String> context)
        throws CameraOperationException,
               NotEnabledException
    {
        try
        {
            return _iceI_setCameraModeAsync(mode, context, true).waitForResponseOrUserEx();
        }
        catch(CameraOperationException ex)
        {
            throw ex;
        }
        catch(NotEnabledException ex)
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Boolean> setCameraModeAsync(CameraMode mode)
    {
        return _iceI_setCameraModeAsync(mode, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> setCameraModeAsync(CameraMode mode, java.util.Map<String, String> context)
    {
        return _iceI_setCameraModeAsync(mode, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_setCameraModeAsync(CameraMode iceP_mode, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setCameraMode", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_setCameraMode);
        f.invoke(true, context, null, ostr -> {
                     CameraMode.ice_write(ostr, iceP_mode);
                 }, istr -> {
                     boolean ret;
                     ret = istr.readBool();
                     return ret;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_setCameraMode =
    {
        CameraOperationException.class,
        NotEnabledException.class
    };
