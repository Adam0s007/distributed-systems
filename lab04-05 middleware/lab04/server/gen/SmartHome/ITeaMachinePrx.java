...
public interface ITeaMachinePrx extends IDrinksMachinePrx
{
    default boolean makeTea(Tea tea)
        throws NotEnabledException,
               ResourceLimitException
    {
        return makeTea(tea, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean makeTea(Tea tea, java.util.Map<String, String> context)
        throws NotEnabledException,
               ResourceLimitException
    {
        try
        {
            return _iceI_makeTeaAsync(tea, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Boolean> makeTeaAsync(Tea tea)
    {
        return _iceI_makeTeaAsync(tea, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> makeTeaAsync(Tea tea, java.util.Map<String, String> context)
    {
        return _iceI_makeTeaAsync(tea, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_makeTeaAsync(Tea iceP_tea, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "makeTea", null, sync, _iceE_makeTea);
    ...
    default void addTeaLeavesOfType(TeaType type, int amount)
        throws NotEnabledException,
               TeaLeafCapacityException
    {
        addTeaLeavesOfType(type, amount, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void addTeaLeavesOfType(TeaType type, int amount, java.util.Map<String, String> context)
        throws NotEnabledException,
               TeaLeafCapacityException
    {
        try
        {
            _iceI_addTeaLeavesOfTypeAsync(type, amount, context, true).waitForResponseOrUserEx();
        }
        catch(NotEnabledException ex)
        {
            throw ex;
        }
        catch(TeaLeafCapacityException ex)
        {
            throw ex;
        }
        catch(com.zeroc.Ice.UserException ex)
    ...
    default java.util.concurrent.CompletableFuture<Void> addTeaLeavesOfTypeAsync(TeaType type, int amount)
    {
        return _iceI_addTeaLeavesOfTypeAsync(type, amount, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> addTeaLeavesOfTypeAsync(TeaType type, int amount, java.util.Map<String, String> context)
    {
        return _iceI_addTeaLeavesOfTypeAsync(type, amount, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_addTeaLeavesOfTypeAsync(TeaType iceP_type, int iceP_amount, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "addTeaLeavesOfType", null, sync, _iceE_addTeaLeavesOfType);
        f.invoke(true, context, null, ostr -> {
                     TeaType.ice_write(ostr, iceP_type);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_addTeaLeavesOfType =
    {
        NotEnabledException.class,
        TeaLeafCapacityException.class
    };

    default java.util.List<MachineTeaInfo> getTeaList()
        throws NotEnabledException
    {
        return getTeaList(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default java.util.List<MachineTeaInfo> getTeaList(java.util.Map<String, String> context)
        throws NotEnabledException
    {
        try
        {
            return _iceI_getTeaListAsync(context, true).waitForResponseOrUserEx();
        }
        catch(NotEnabledException ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<java.util.List<MachineTeaInfo>> getTeaListAsync()
    {
        return _iceI_getTeaListAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.util.List<MachineTeaInfo>> getTeaListAsync(java.util.Map<String, String> context)
    {
        return _iceI_getTeaListAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.util.List<MachineTeaInfo>> _iceI_getTeaListAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.List<MachineTeaInfo>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getTeaList", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_getTeaList);
        f.invoke(true, context, null, null, istr -> {
                     java.util.List<MachineTeaInfo> ret;
                     ret = TeaListHelper.read(istr);
                     return ret;
                 });
        return f;
    }
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getTeaList =
    {
        NotEnabledException.class
    };
