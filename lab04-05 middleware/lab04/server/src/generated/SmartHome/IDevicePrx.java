...
public interface IDevicePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        isTurnedOn(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void isTurnedOn(java.util.Map<String, String> context)
        throws NotEnabledException
    {
        try
        {
            _iceI_isTurnedOnAsync(context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<Void> isTurnedOnAsync()
    {
        return _iceI_isTurnedOnAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> isTurnedOnAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_isTurnedOnAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "isTurnedOn", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_isTurnedOn);
        f.invoke(true, context, null, null, null);
        return f;
    }

    /** @hidden */
    static final Class<?>[] _iceE_isTurnedOn =
    {
