...
public interface ITelevisionPrx extends IDevicePrx
{
    ...
    {
        return _iceI_getChannelListAsync(context, true).waitForResponse();
    }
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.List<TVChannel>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getChannelList", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
