...
public interface ITeaMachinePrx extends IDrinksMachinePrx
{
    ...
    {
        return _iceI_getTeaListAsync(context, true).waitForResponse();
    }
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.List<MachineTeaInfo>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getTeaList", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
