...
public interface ICameraPrx extends IDevicePrx
{
    ...
    {
        return _iceI_getCameraModeAsync(context, true).waitForResponse();
    }
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<CameraMode> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getCameraMode", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
